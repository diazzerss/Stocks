...
class DetailsViewModel @ViewModelInject constructor(private val quoteRepositoryImpl: QuoteRepositoryImpl) : BaseViewModel() {
    ...
    fun loadQuote(ticker: String) {
        ...
        viewModelScope.launch {
            ...
            launch(Dispatchers.IO) {
                try {
                    val quote = quoteRepositoryImpl.getQuote(ticker)
